...
namespace Obacher.RandomOrgSharp.JsonRPC.Method
{
    ...
    /// </remarks>
    public class IntegerSignedMethod : IntegerBasicMethod
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public IntegerSignedMethod(AdvisoryDelayHandler advisoryDelayHandler, IRandomService randomService = null) : base(advisoryDelayHandler, randomService)
        {
