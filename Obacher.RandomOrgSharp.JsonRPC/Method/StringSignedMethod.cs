...
namespace Obacher.RandomOrgSharp.JsonRPC.Method
{
    ...
    /// </remarks>
    public class StringSignedMethod
    {
        ...
        public StringSignedMethod(AdvisoryDelayHandler advisoryDelayHandler, IRandomService service = null)
        {
            ...
            _beforeRequestCommandFactory = new BeforeRequestCommandFactory(advisoryDelayHandler, verifySignatureHandler);
        ...
        public IEnumerable<string> GenerateGuassians(int numberOfItemsToReturn, int length, CharactersAllowed charactersAllowed, bool allowDuplicates = true)
        {
            IParameters requestParameters = StringParameters.Create(numberOfItemsToReturn, length, charactersAllowed, allowDuplicates);
            IMethodCallBroker broker = new MethodCallBroker(_requestBuilder, _service, _beforeRequestCommandFactory, _responseHandlerFactory);
        ...
        /// <param name="allowDuplicates">True if duplicate values are allowed in the random values, default to <c>true</c></param>
        /// <returns>List of random blob values</returns>
        public IEnumerable<string> GenerateGuassians(int numberOfItemsToReturn, int length, string charactersAllowed, bool allowDuplicates = true)
        {
            IParameters requestParameters = StringParameters.Create(numberOfItemsToReturn, length, charactersAllowed, allowDuplicates);
            IMethodCallBroker broker = new MethodCallBroker(_requestBuilder, _service, _beforeRequestCommandFactory, _responseHandlerFactory);
            broker.Generate(requestParameters);
        ...
        /// <param name="allowDuplicates">True if duplicate values are allowed in the random values, default to <c>true</c></param>
        /// <returns>List of random blob values</returns>
        public async Task<IEnumerable<string>> GenerateGuassiansAsync(int numberOfItemsToReturn, int length, CharactersAllowed charactersAllowed, bool allowDuplicates = true)
        {
            IParameters requestParameters = StringParameters.Create(numberOfItemsToReturn, length, charactersAllowed, allowDuplicates);
            MethodCallBroker broker = new MethodCallBroker(_requestBuilder, _service, _beforeRequestCommandFactory, _responseHandlerFactory);
        ...
        /// <param name="allowDuplicates">True if duplicate values are allowed in the random values, default to <c>true</c></param>
        /// <returns>List of random blob values</returns>
        public async Task<IEnumerable<string>> GenerateGuassiansAsync(int numberOfItemsToReturn, int length, string charactersAllowed, bool allowDuplicates = true)
        {
            IParameters requestParameters = StringParameters.Create(numberOfItemsToReturn, length, charactersAllowed, allowDuplicates);
            MethodCallBroker broker = new MethodCallBroker(_requestBuilder, _service, _beforeRequestCommandFactory, _responseHandlerFactory);
            await broker.GenerateAsync(requestParameters);
