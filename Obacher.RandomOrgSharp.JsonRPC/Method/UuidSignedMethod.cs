...
namespace Obacher.RandomOrgSharp.JsonRPC.Method
{
    ...
    /// </remarks>
    public class UuidSignedMethod : UuidBasicMethod
    {
        /// <summary>
        /// Constructor
        /// </summary>
        ...
        public UuidSignedMethod(AdvisoryDelayHandler advisoryDelayHandler, IRandomService randomService = null) : base(advisoryDelayHandler, randomService)
        {
